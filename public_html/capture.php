...
<footer>
        ...
        <small class="desenvolvedor">
							...
							<!--
							<form id="loginForm" method="post" class="form" action="index.php" role="form">
								<div class="text-center">
									<h3 class="page-header">ControlPlan :: Acesso aos Sistemas</h3>
								</div>
								...
								<div class="text-right">
									...
									<input type="hidden" name="command" value="efetuarLogin" />
									<input type="hidden" name="action" value="performAction" />
